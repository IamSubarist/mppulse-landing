  ...
  return (
    <div className="relative flex flex-col items-center justify-center">
      <div className="z-20 shadow-xl rounded-[25px] bg-white flex flex-col min-[768px]:px-[40px] min-[1600px]:px-[44px] py-[44px] gap-[30px]">
        ...
        <div>
          <button className="w-[292px] h-[70px] rounded-[18.81px] border border-[#4C3AFF] flex items-center justify-center gap-2">
            <p className="text-[15.63px] font-bold text-blue-500 leading-[105%] uppercase">
              Посмотреть демо
            </p>
            <svg
              width="33"
