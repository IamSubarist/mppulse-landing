    ...
    <div className="mt-[44px] relative flex flex-col items-center justify-center">
      <div className="min-h-[425px] z-20 shadow-xl rounded-[25px] bg-white flex flex-col min-[768px]:px-[38px] min-[1600px]:px-[44px] min-[768px]:py-[44px_36px] min-[1600px]:py-[44px_44px]">
        ...
        <div className="flex-1 min-[768px]:grid min-[768px]:grid-cols-2 min-[768px]:gap-x-[30px] min-[1600px]:hidden">
          ...
          <div className="ml-8 flex flex-col min-[768px]:gap-[17.46px]">
            ...
            <div className="flex items-start gap-2 relative pl-1 mt-[8px]">
              <button className="min-[768px]:px-[40px] min-[1600px]:px-[46px] min-[768px]:h-[62px] min-[1600px]:h-[70px] rounded-[18.81px] border border-[#4C3AFF] flex items-center justify-center min-[768px]:gap-[7.51px] min-[1600px]:gap-2">
                <p className="min-w-[142px] min-[768px]:text-[14.01px] min-[1600px]:text-[15.63px] font-bold text-blue-500 leading-[105%] uppercase">
                  Посмотреть демо
                </p>
                <svg
                  width="33"
        ...
        <div className="hidden min-[1600px]:flex flex-col">
          ...
          <button className="min-[1600px]:px-[46px] min-[1600px]:h-[70px] rounded-[18.81px] border border-[#4C3AFF] flex items-center justify-center min-[1600px]:gap-2">
            <p className="min-w-[142px] min-[1600px]:text-[15.63px] font-bold text-blue-500 leading-[105%] uppercase">
              Посмотреть демо
            </p>
            <svg
              width="33"
