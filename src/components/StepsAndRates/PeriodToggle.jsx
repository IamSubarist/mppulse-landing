...
export const PeriodToggle = ({ onPeriodChange }) => {
  ...
  return (
    <div className="flex items-center w-[250px] min-[768px]:w-[304.94px] min-[1600px]:w-[380px] h-[57px] min-[768px]:h-[56px] min-[1600px]:h-[70px] border-3 border-white rounded-[13.93px] min-[768px]:rounded-[18.81px] uppercase mb-[40px] min-[768px]:mb-[40px] min-[1600px]:mb-[36px]">
      ...
      >
        6 месяцев
        <div className="rounded-[5.57px] absolute -top-3 min-[768px]:right-[26px] min-[1600px]:right-[34px] w-[69.49px] min-[768px]:w-[93.89px] min-[1600px]:w-[117px] h-[14.55px] min-[768px]:h-[19.67px] min-[1600px]:h-[24.51px] bg-[#3DBB36] flex items-center justify-center">
