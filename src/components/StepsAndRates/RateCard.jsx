    ...
    <div className="relative flex flex-col items-center justify-center">
      ...
      <div className="z-[2] shadow-xl min-[768px]:w-[340px] min-[1600px]:w-[380px] rounded-[25px] bg-white flex flex-col px-[32.74px] min-[768px]:px-[34px] min-[1600px]:px-[39px] py-[34px_34px] min-[768px]:py-[39px_44px] gap-6 min-[768px]:gap-[24px] min-[1600px]:gap-[32px]">
        ...
        <div className="flex flex-col items-center justify-center mt-[22px] gap-[18px]">
          ...
          <div>
            <button className="cursor-pointer w-[245px] min-[768px]:w-[261.69px] min-[1600px]:w-[292px] h-[63.72px] min-[768px]:h-[68.03px] min-[1600px]:h-[75.91px] rounded-[12.65px] bg-gradient-to-r from-[#4C3AFF] to-[#49BCFF] flex items-center justify-center gap-2">
