...
export const KeyFunctions = () => {
  return (
    <div className="keyfunc-section min-[360px]:px-[2.605%] min-[768px]:px-[4%] min-[1600px]:px-[18.7%] relative h-[1890px]">
      ...
      <div className="min-[768px]:pt-[970px] min-[1600px]:pt-[624px]">
        <p className="min-[768px]:text-[35px] min-[1600px]:text-[47.04px] font-bold leading-[115%] tracking-[-1.5px] mb-[92px] text-center">
          Три <span className="text-[#4C51FF]">ключевые</span> функции
        </p>
        <div className="flex min-[1600px]:flex-row flex-col items-start justify-center gap-[30px]">
